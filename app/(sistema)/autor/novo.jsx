...
export const schema = yup.object({
    ...
    apelido: yup.string()
        .min(1, 'O apelido deve conter, no mínimo, 10 caracteres')
        .max(100, 'O apelido deve conter, no máximo, 100 caracteres')
...
export default function LeitorNovo() {
    ...
    useEffect(() => {
        if (modalShow === false) {
            reset({ nome: '', apelido: '', email: '', nascimento: '', senha: '', status: ''})
        }
    }, [modalShow]);
